...
pub fn _Py_IS_TYPE(arg_ob: [*c]const PyObject, arg_type: [*c]const PyTypeObject) callconv(.C) c_int {
    var ob = arg_ob;
    var @"type" = arg_type;
    return @intFromBool(ob.*.ob_type == @as([*c]PyTypeObject, @ptrCast(@volatileCast(@constCast(@"type")))));
}
...
pub fn _PyObject_TypeCheck(arg_ob: [*c]PyObject, arg_type: [*c]PyTypeObject) callconv(.C) c_int {
    var ob = arg_ob;
    var @"type" = arg_type;
    return @intFromBool((_Py_IS_TYPE(@as([*c]const PyObject, @ptrCast(@alignCast(ob))), @"type") != 0) or (PyType_IsSubtype(ob.*.ob_type, @"type") != 0));
}
...
pub fn _Py_DECREF(arg_op: [*c]PyObject) callconv(.C) void {
    ...
    if ((blk: {
        ...
        ref.* -= 1;
        break :blk ref.*;
    }) != @as(Py_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {} else {
        _Py_Dealloc(op);
    }
}
...
pub fn _PyType_Check(arg_op: [*c]PyObject) callconv(.C) c_int {
    var op = arg_op;
    return PyType_HasFeature(op.*.ob_type, @as(c_ulong, 1) << @intCast(31));
}
pub fn _PyType_CheckExact(arg_op: [*c]PyObject) callconv(.C) c_int {
    var op = arg_op;
    return _Py_IS_TYPE(@as([*c]const PyObject, @ptrCast(@alignCast(op))), &PyType_Type);
}
...
pub fn Py_UNICODE_COPY(arg_target: [*c]Py_UNICODE, arg_source: [*c]const Py_UNICODE, arg_length: Py_ssize_t) callconv(.C) void {
    ...
    _ = memcpy(@as(?*anyopaque, @ptrCast(target)), @as(?*const anyopaque, @ptrCast(source)), @as(usize, @bitCast(length)) *% @sizeOf(Py_UNICODE));
}
...
pub fn _PyUnicode_get_wstr_length(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    var op = arg_op;
    return if ((@as(c_int, @bitCast(@as(?*PyASCIIObject, @ptrCast(@alignCast(op))).*.state.ascii)) != 0) and (@as(c_int, @bitCast(@as(?*PyASCIIObject, @ptrCast(@alignCast(op))).*.state.compact)) != 0)) @as(?*PyASCIIObject, @ptrCast(@alignCast(op))).*.length else @as(?*PyCompactUnicodeObject, @ptrCast(@alignCast(op))).*.wstr_length;
}
...
pub fn PyVectorcall_Function(arg_callable: [*c]PyObject) callconv(.C) vectorcallfunc {
    ...
    _ = @as(c_int, 0);
    tp = callable.*.ob_type;
    if (!(PyType_HasFeature(tp, @as(c_ulong, 1) << @intCast(11)) != 0)) {
        return null;
    }
    _ = @as(c_int, 0);
    offset = tp.*.tp_vectorcall_offset;
    _ = @as(c_int, 0);
    _ = memcpy(@as(?*anyopaque, @ptrCast(&ptr)), @as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(callable))) + @as(usize, @bitCast(@as(isize, @intCast(offset)))))), @sizeOf(vectorcallfunc));
    return ptr;
}
pub fn _PyObject_VectorcallTstate(arg_tstate: [*c]PyThreadState, arg_callable: [*c]PyObject, arg_args: [*c]const [*c]PyObject, arg_nargsf: usize, arg_kwnames: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    if (func == @as(vectorcallfunc, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
...
pub fn _PyObject_FastCallTstate(arg_tstate: [*c]PyThreadState, arg_func: [*c]PyObject, arg_args: [*c]const [*c]PyObject, arg_nargs: Py_ssize_t) callconv(.C) [*c]PyObject {
    ...
    var args = arg_args;
    var nargs = arg_nargs;
    return _PyObject_VectorcallTstate(tstate, func, args, @as(usize, @bitCast(nargs)), null);
}
...
pub fn _PyObject_CallNoArg(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    var func = arg_func;
    var tstate: [*c]PyThreadState = PyThreadState_Get();
    return _PyObject_VectorcallTstate(tstate, func, null, @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))), null);
}
pub fn PyObject_CallOneArg(arg_func: [*c]PyObject, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = @as(c_int, 0);
    args = @as([*c][*c]PyObject, @ptrCast(@alignCast(&_args))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    args[@as(c_uint, @intCast(@as(c_int, 0)))] = arg;
    tstate = PyThreadState_Get();
    nargsf = @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) | (@as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) << @intCast((@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))) *% @sizeOf(usize)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))));
...
pub fn PyObject_CallMethodNoArgs(arg_self: [*c]PyObject, arg_name: [*c]PyObject) callconv(.C) [*c]PyObject {
    var self = arg_self;
    var name = arg_name;
    return PyObject_VectorcallMethod(name, &self, @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) | (@as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) << @intCast((@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))) *% @sizeOf(usize)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))), null);
}
pub fn PyObject_CallMethodOneArg(arg_self: [*c]PyObject, arg_name: [*c]PyObject, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = @as(c_int, 0);
    return PyObject_VectorcallMethod(name, @as([*c][*c]PyObject, @ptrCast(@alignCast(&args))), @as(usize, @bitCast(@as(c_long, @as(c_int, 2)))) | (@as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) << @intCast((@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))) *% @sizeOf(usize)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))), null);
}
...
pub fn _PyObject_CallMethodIdNoArgs(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier) callconv(.C) [*c]PyObject {
    var self = arg_self;
    var name = arg_name;
    return _PyObject_VectorcallMethodId(name, &self, @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) | (@as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) << @intCast((@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))) *% @sizeOf(usize)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))), null);
}
pub fn _PyObject_CallMethodIdOneArg(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = @as(c_int, 0);
    return _PyObject_VectorcallMethodId(name, @as([*c][*c]PyObject, @ptrCast(@alignCast(&args))), @as(usize, @bitCast(@as(c_long, @as(c_int, 2)))) | (@as(usize, @bitCast(@as(c_long, @as(c_int, 1)))) << @intCast((@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))) *% @sizeOf(usize)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))), null);
}
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /usr/local/zig/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /usr/local/zig/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /usr/local/zig/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /usr/local/zig/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /usr/local/zig/lib/include/stdarg.h:46:9
...
pub const Py_NAN = Py_HUGE_VAL * @as(f64, 0.0);
pub inline fn Py_OVERFLOWED(X: anytype) @TypeOf((X != @as(f64, 0.0)) and (((errno == ERANGE) or (X == Py_HUGE_VAL)) or (X == -Py_HUGE_VAL))) {
    return (X != @as(f64, 0.0)) and (((errno == ERANGE) or (X == Py_HUGE_VAL)) or (X == -Py_HUGE_VAL));
}
...
pub inline fn PyByteArray_AS_STRING(self: anytype) @TypeOf(if (Py_SIZE(self)) @import("std").zig.c_translation.cast([*c]PyByteArrayObject, self).*.ob_start else _PyByteArray_empty_string) {
    return blk_1: {
        ...
        break :blk_1 if (Py_SIZE(self)) @import("std").zig.c_translation.cast([*c]PyByteArrayObject, self).*.ob_start else _PyByteArray_empty_string;
    };
}
pub inline fn PyByteArray_GET_SIZE(self: anytype) @TypeOf(Py_SIZE(self)) {
    return blk_1: {
        _ = assert(PyByteArray_Check(self));
        break :blk_1 Py_SIZE(self);
    };
}
...
pub inline fn PyBytes_AS_STRING(op: anytype) @TypeOf(@import("std").zig.c_translation.cast([*c]PyBytesObject, op).*.ob_sval) {
    return blk_1: {
        ...
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyBytesObject, op).*.ob_sval;
    };
}
pub inline fn PyBytes_GET_SIZE(op: anytype) @TypeOf(Py_SIZE(op)) {
    return blk_1: {
        _ = assert(PyBytes_Check(op));
        break :blk_1 Py_SIZE(op);
    };
}
...
pub inline fn PyUnicode_GET_SIZE(op: anytype) @TypeOf(if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) PyUnicode_WSTR_LENGTH(op) else blk_2: {
    ...
    break :blk_2 PyUnicode_WSTR_LENGTH(op);
}) {
    return blk_1: {
        _ = assert(PyUnicode_Check(op));
        break :blk_1 if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) PyUnicode_WSTR_LENGTH(op) else blk_2: {
            _ = @import("std").zig.c_translation.cast(anyopaque, PyUnicode_AsUnicode(_PyObject_CAST(op)));
            _ = assert(@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr);
            break :blk_2 PyUnicode_WSTR_LENGTH(op);
        };
...
pub inline fn PyUnicode_AS_UNICODE(op: anytype) @TypeOf(if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) @import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr else PyUnicode_AsUnicode(_PyObject_CAST(op))) {
    return blk_1: {
        _ = assert(PyUnicode_Check(op));
        break :blk_1 if (@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr) @import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.wstr else PyUnicode_AsUnicode(_PyObject_CAST(op));
    };
}
...
pub inline fn PyUnicode_IS_ASCII(op: anytype) @TypeOf(@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.state.ascii) {
    return blk_1: {
        ...
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.state.ascii;
    };
}
...
pub inline fn PyUnicode_KIND(op: anytype) @TypeOf(@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.state.kind) {
    return blk_1: {
        _ = assert(PyUnicode_Check(op));
        _ = assert(PyUnicode_IS_READY(op));
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.state.kind;
    };
}
...
pub inline fn _PyUnicode_NONCOMPACT_DATA(op: anytype) @TypeOf(@import("std").zig.c_translation.cast([*c]PyUnicodeObject, op).*.data.any) {
    return blk_1: {
        ...
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyUnicodeObject, op).*.data.any;
    };
}
pub inline fn PyUnicode_DATA(op: anytype) @TypeOf(if (PyUnicode_IS_COMPACT(op)) _PyUnicode_COMPACT_DATA(op) else _PyUnicode_NONCOMPACT_DATA(op)) {
    return blk_1: {
        _ = assert(PyUnicode_Check(op));
        break :blk_1 if (PyUnicode_IS_COMPACT(op)) _PyUnicode_COMPACT_DATA(op) else _PyUnicode_NONCOMPACT_DATA(op);
    };
}
pub inline fn PyUnicode_GET_LENGTH(op: anytype) @TypeOf(@import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.length) {
    return blk_1: {
        _ = assert(PyUnicode_Check(op));
        _ = assert(PyUnicode_IS_READY(op));
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyASCIIObject, op).*.length;
    };
}
...
pub inline fn PyUnicode_READY(op: anytype) @TypeOf(if (PyUnicode_IS_READY(op)) @as(c_int, 0) else _PyUnicode_Ready(_PyObject_CAST(op))) {
    return blk_1: {
        _ = assert(PyUnicode_Check(op));
        break :blk_1 if (PyUnicode_IS_READY(op)) @as(c_int, 0) else _PyUnicode_Ready(_PyObject_CAST(op));
    };
}
pub inline fn PyUnicode_MAX_CHAR_VALUE(op: anytype) @TypeOf(if (PyUnicode_IS_ASCII(op)) @as(c_int, 0x7f) else if (PyUnicode_KIND(op) == PyUnicode_1BYTE_KIND) @as(c_uint, 0xff) else if (PyUnicode_KIND(op) == PyUnicode_2BYTE_KIND) @as(c_uint, 0xffff) else @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10ffff, .hexadecimal)) {
    return blk_1: {
        _ = assert(PyUnicode_IS_READY(op));
        break :blk_1 if (PyUnicode_IS_ASCII(op)) @as(c_int, 0x7f) else if (PyUnicode_KIND(op) == PyUnicode_1BYTE_KIND) @as(c_uint, 0xff) else if (PyUnicode_KIND(op) == PyUnicode_2BYTE_KIND) @as(c_uint, 0xffff) else @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10ffff, .hexadecimal);
    };
}
...
pub inline fn _PyTuple_CAST(op: anytype) [*c]PyTupleObject {
    return blk_1: {
        ...
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyTupleObject, op);
    };
}
pub inline fn PyTuple_GET_SIZE(op: anytype) @TypeOf(Py_SIZE(_PyTuple_CAST(op))) {
    return Py_SIZE(_PyTuple_CAST(op));
}
pub inline fn PyTuple_GET_ITEM(op: anytype, i: anytype) @TypeOf(_PyTuple_CAST(op).*.ob_item[@as(usize, @intCast(i))]) {
    return _PyTuple_CAST(op).*.ob_item[@as(usize, @intCast(i))];
}
...
pub inline fn _PyList_CAST(op: anytype) [*c]PyListObject {
    return blk_1: {
        ...
        break :blk_1 @import("std").zig.c_translation.cast([*c]PyListObject, op);
    };
}
pub inline fn PyList_GET_ITEM(op: anytype, i: anytype) @TypeOf(_PyList_CAST(op).*.ob_item[@as(usize, @intCast(i))]) {
    return _PyList_CAST(op).*.ob_item[@as(usize, @intCast(i))];
}
