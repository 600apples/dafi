...
class MessagerService(object):
    ...
    def communicate(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/MessagerService/communicate',
    ...
    @staticmethod
    def stream_to_controller(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/MessagerService/stream_to_controller',
            messager__pb2.Message.SerializeToString,
    ...
    @staticmethod
    def stream_from_controller(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/MessagerService/stream_from_controller',
