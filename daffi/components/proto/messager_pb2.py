...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MESSAGEFLAG._serialized_end = 1040
    ...
    _MESSAGERSERVICE._serialized_start = 1043
    _MESSAGERSERVICE._serialized_end = 1189
